                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="hidden sm:flex items-center space-x-2">
                    ...
                    <div className="text-sm">
                      ...
                      <div className="text-xs ghost">Signed in</div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="btn text-sm px-3 py-2 rounded-lg hover:bg-red-500/20 hover:border-red-400/40 hover:text-red-400 transition-all"
                  >
                    Sign Out
                  </button>
                </div>
