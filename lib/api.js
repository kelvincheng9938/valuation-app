...
// 🔥 FIXED: Hong Kong stock symbols to filter out from initial positions - ENSURE 9988 IS INCLUDED
...
function applyOverlayFixed(baseData, overlayMap) {
  ...
  overlayMap.forEach((overlayData, ticker) => {
    if (!processedTickers.has(ticker)) {
      ...
      // 🔥 AGGRESSIVE FIX: Block ALL HK stocks from being added from overlay
