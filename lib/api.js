// lib/api.js - FIXED: Proper Google Sheet overlay for ORCL and other tickers
      ...
      if (overlayUrl) {
        ...
        if (csvText) {
          ...
          if (hasOverlayData) {
            ...
            throw new Error(`Ticker "${ticker.toUpperCase()}" not found in data sources. Please verify the symbol and ensure it exists in your Google Sheet.`)
          }
        }
      } else {
...
// 🔥 FIXED: Create proper minimal stock data for overlay-only tickers
