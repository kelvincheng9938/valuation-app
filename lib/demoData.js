...
export const DEMO_STOCK_DATA = {
  ...
  'AMD': {
    ...
    marketCap: '201B',
    sector: 'Technology',
    description: 'Advanced Micro Devices designs and manufactures microprocessors, graphics processing units, and related technologies.',
    ...
    forwardPE: '29.2', ttmPE: '32.1',
    peers: [[201, 29.2, 16, 'AMD'], [3700, 50.4, 30, 'NVDA']],
    segments: [
  ...
  'NFLX': {
    ...
    forwardPE: '47.6', ttmPE: '43.8',
    peers: [[398, 47.6, 18, 'NFLX'], [152, 18.7, 16, 'DIS']],
    segments: [
    ...
    news: [{ headline: 'Netflix ad-tier reaches 45M users', summary: 'Strong advertising revenue growth', source: 'Variety', datetime: '5 hours ago', url: '#' }]
  },

  // Add remaining stocks with updated prices... (abbreviated for space)
  'BAC': {
    ticker: 'BAC', name: 'Bank of America Corp', price: 47.89, change: 0.87, changePercent: 1.85,
    marketCap: '375B', sector: 'Financials', forwardPE: '12.8', ttmPE: '14.2',
    ...
    description: 'Bank of America Corporation operates as a bank holding company.',
    peers: [[375, 12.8, 18, 'BAC'], [590, 14.8, 20, 'JPM']],
    segments: [{ name: 'Consumer Banking', value: 52, itemStyle: { color: '#3b82f6' } }, { name: 'Global Banking', value: 22, itemStyle: { color: '#10b981' } }],
    strengths: ['Largest US deposit base', 'Strong digital platform'], risks: ['Interest rate sensitivity', 'Credit provisions'],
    news: [{ headline: 'BAC reports strong Q3 results', summary: 'Beat earnings expectations', source: 'Financial Times', datetime: '4 hours ago', url: '#' }]
  },

  // Add remaining stocks following same pattern...
  'DIS': { ticker: 'DIS', name: 'The Walt Disney Company', price: 96.45, change: 1.78, changePercent: 1.88, marketCap: '176B', sector: 'Communication Services' },
  'HD': { ticker: 'HD', name: 'The Home Depot Inc.', price: 418.67, change: 6.23, changePercent: 1.51, marketCap: '415B', sector: 'Consumer Discretionary' },
  'KO': { ticker: 'KO', name: 'The Coca-Cola Company', price: 64.12, change: 0.34, changePercent: 0.53, marketCap: '278B', sector: 'Consumer Staples' },
  'MCD': { ticker: 'MCD', name: 'McDonald\'s Corporation', price: 301.23, change: 4.78, changePercent: 1.61, marketCap: '218B', sector: 'Consumer Discretionary' },
  'NKE': { ticker: 'NKE', name: 'Nike Inc.', price: 79.89, change: 1.65, changePercent: 2.11, marketCap: '120B', sector: 'Consumer Discretionary' },
  'QCOM': { ticker: 'QCOM', name: 'QUALCOMM Incorporated', price: 162.34, change: 3.67, changePercent: 2.31, marketCap: '182B', sector: 'Technology' },
  'UBER': { ticker: 'UBER', name: 'Uber Technologies Inc.', price: 69.45, change: 2.56, changePercent: 3.83, marketCap: '146B', sector: 'Technology' },
  'COIN': { ticker: 'COIN', name: 'Coinbase Global Inc.', price: 318.67, change: 22.23, changePercent: 7.50, marketCap: '82B', sector: 'Financial Services' }
};
